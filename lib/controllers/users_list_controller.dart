...
class UsersListController extends GetxController {
  ...
  void _loadRelationships() {
    ...
    if (currentUserId != null) {
      ...
      // update relationships whenever any of the lists change
    ...
    try {
      ...
      if (currentUserId != null) {
        ...
        if (request != null) {
          ...
          // Force update the relationship status
          _userRelationships[user.id] = UserRelationshipStatus.friends;
          
          // Trigger a manual update of all relationships to ensure consistency
